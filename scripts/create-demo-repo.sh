...
cp "$ROOT/.codex/agents/pulmu-explorer.toml" "$TARGET/.codex/agents/pulmu-explorer.toml"
cp "$ROOT/.codex/agents/pulmu-reviewer.toml" "$TARGET/.codex/agents/pulmu-reviewer.toml"
